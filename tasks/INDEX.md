...
- [ ] TASK-020: Metadata Extraction (Language, Title, Keywords)
- [ ] TASK-021: PDF Layout Analysis (Handling tables and headers)

### 5. Embedding Pipeline
- [ ] TASK-022: Chunking Service (Recursive Character Splitting)
- [ ] TASK-023: Semantic Chunking Implementation
- [ ] TASK-024: Embedding Service Abstraction
- [ ] TASK-025: OpenAI Embedding Integration
- [ ] TASK-026: Gemini Embedding Integration
- [ ] TASK-027: Batch Embedding Processing with Rate Limiting

### 6. Vector Storage
- [ ] TASK-028: Vector Storage Repository (pgvector)
- [ ] TASK-029: HNSW Index Configuration for Vector Search
- [ ] TASK-030: Metadata Filtering Implementation
- [ ] TASK-031: Hybrid Search Storage (BM25 + Vector)

### 7. Retrieval System
- [ ] TASK-032: Vector Similarity Search Logic
- [ ] TASK-033: BM25 Keyword Search Implementation
- [ ] TASK-034: Hybrid Search Orchestrator
- [ ] TASK-035: Cross-Encoder Reranking Integration
- [ ] TASK-036: Multi-turn Context Retrieval (Windowing)

### 8. RAG Orchestration
- [ ] TASK-037: LLM Service Abstraction (OpenAI/Gemini)
- [ ] TASK-038: Prompt Template Management System
- [ ] TASK-039: Grounded Generation (Context Injection)
- [ ] TASK-040: Citation Generation and Verification Logic
- [ ] TASK-041: Streaming Response Implementation
- [ ] TASK-042: Hallucination Detection (Basic)

### 9. Chat Experience (Backend)
- [ ] TASK-043: Conversation and Message Models
- [ ] TASK-044: Chat History Persistence
- [ ] TASK-045: Chat API Endpoint (Streaming & Non-streaming)
- [ ] TASK-046: Source Preview API (Retrieve specific chunks)
- [ ] TASK-047: Feedback Collection (Thumbs up/down)

### 10. Frontend - Foundation
- [ ] TASK-048: Next.js Project Setup with Tailwind CSS
- [ ] TASK-049: API Client and Interceptors
- [ ] TASK-050: Auth Context and Protected Routes
- [ ] TASK-051: Design System (Shadcn/UI components)

### 11. Frontend - Chat Interface
- [ ] TASK-052: Main Chat Layout and Sidebar
- [ ] TASK-053: Message Components (Markdown Support)
- [ ] TASK-054: Source Citation Tooltips and Popovers
- [ ] TASK-055: Document Source Viewer (PDF Sidebar)
- [ ] TASK-056: Typing Indicators and Streaming UI

### 12. Frontend - Document Management
- [ ] TASK-057: Document Upload Interface (Drag & Drop)
- [ ] TASK-058: Document List and Status Tracking
- [ ] TASK-059: Document Search and Filtering
- [ ] TASK-060: Document Metadata Editing
